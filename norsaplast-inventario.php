...
<div id="contenido">
    ...
    <!-- Incluimos el Navbar -->
    <?php get_navbar('Norsaplast', 'Norsaplast a Inventario', true); ?>
    ...
    <div class="table-responsive-lg">
        <table class="table table-bordered text-center" id="tabla">
            ...
            <tr>
                ...
                <th scope="col">De Molino a Inventario</th>
            ...
            foreach ($result as $row) {
                ...
                echo "<td>
                        <a href='#' data-toggle='modal' data-target='#verSolicitud-modal' data-solicitud-material-id='{$row['SOLICITUD_MATERIAL_ID']}'>
